...
Remote access must keep the server on loopback. Use the Tailscale Serve
route above or bb connect; direct LAN/tailnet binding is not supported because
the server API is unauthenticated and permits command execution and file reads.
