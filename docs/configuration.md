...
| ------------------------------------- | -------------------------------------------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `BB_ADDITIONAL_WORKSPACE_WRITE_ROOTS` | `bb-app env`, or environment                       | Startup-only            | Host-local absolute paths added to every provider workspace-write sandbox. Separate paths with the platform path delimiter (`:` on macOS/Linux and `;` on Windows). Keep this list narrow. A full launcher or desktop app restart is required.                                                                                                                                                        |
