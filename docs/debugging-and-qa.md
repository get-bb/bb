...
- Worktree startup caches bundled-plugin packaging through Turbo and builds independent plugins with bounded concurrency. See [startup performance](worktree-startup-performance.md) for measurements and cache behavior.
