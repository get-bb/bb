...
- Worktree startup caches bundled-plugin packaging through Turbo and reuses unchanged React Compiler transforms between production builds. See [startup performance](worktree-startup-performance.md) for measurements and cache behavior.
