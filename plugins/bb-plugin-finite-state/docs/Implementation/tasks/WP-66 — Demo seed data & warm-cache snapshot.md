...
**Produces a FROZEN artifact:** no — these are E2E-owned derivatives; WP-08's fixture corpus remains frozen
...
`test/mock-remote/fixtures/**` (frozen by WP-08), production source, frozen interfaces, composition roots, external tenant data, or dependencies.
...
type GoldenSeedManifest = {
  ...
  artifacts: Array<{ path: string; sha256: string; purpose: string; schemaVersion?: number }>;
};

export function generateGoldenSeed(destination: string, seed: number): Promise<GoldenSeedManifest>;
...
- [ ] No WP-08 frozen fixture is changed.
...
- `generator writes nothing under frozen mock fixture path`.
