    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Open the root new-thread composer with a project, section, existing environment, or experimental_hostId machine selected; an existing environment takes priority over a machine",
