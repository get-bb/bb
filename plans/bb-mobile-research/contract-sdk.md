...
- environments (763-865): GET/PATCH /environments/:id, GET status, pull-request, diff, diff/files, POST diff/patch, GET diff/file, diff/branches, paths, POST actions (commit/squash_merge; 409 on blocked), POST archive-threads.
