...
const OPTIONAL_SERVER_FIELD_GROUPS: readonly OptionalServerFieldGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      "forkThreadRequestSchema.permissionProfile",
  ...
  },
  {
    ...
    fields: [
      ...
      "createThreadRequestSchema.permissionProfile",
  ...
  },
  {
    ...
    fields: [
      ...
      "createQueuedMessageRequestSchema.executionInputSources.permissionProfile",
      ...
      "createThreadRequestSchema.executionInputSources.permissionProfile",
      ...
      "sendMessageRequestSchema.executionInputSources.permissionProfile",
