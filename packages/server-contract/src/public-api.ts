...
import {
  ...
  peerShareIdentityUpdateSchema,
  peerShareOfferRequestSchema,
  peerShareSendRequestSchema,
...
export const publicApiRoutes = {
  ...
  peerShare: {
    identity: defineRoute({
      path: "/peer-share/identity",
      method: "get",
      request: noRequest(),
      response: jsonResponse<PeerShareIdentity>(),
    }),
    updateIdentity: defineRoute({
      path: "/peer-share/identity",
      method: "put",
      request: jsonRequest<EmptyInput, PeerShareIdentityUpdate>(
        peerShareIdentityUpdateSchema,
      ),
      response: jsonResponse<PeerShareIdentity>(),
    }),
    peers: defineRoute({
      path: "/peer-share/peers",
      method: "get",
      request: noRequest(),
      response: jsonResponse<PeerShareNearbyPeersResponse>(),
    }),
    send: defineRoute({
      path: "/peer-share/send",
      method: "post",
      request: jsonRequest<EmptyInput, PeerShareSendRequest>(
        peerShareSendRequestSchema,
      ),
      response: jsonResponse<{ ok: true }>(),
    }),
    offer: defineRoute({
      path: "/peer-share/offer",
      method: "post",
      request: jsonRequest<EmptyInput, PeerShareOfferRequest>(
        peerShareOfferRequestSchema,
      ),
      response: jsonResponse<{ ok: true }>(),
    }),
    incoming: defineRoute({
      path: "/peer-share/incoming",
      method: "get",
      request: noRequest(),
      response: jsonResponse<PeerShareIncomingListResponse>(),
    }),
    accept: defineRoute({
      path: "/peer-share/incoming/:id/accept",
      method: "post",
      request: noRequest<PathId>(),
      response: jsonResponse<PeerShareAcceptResponse>(),
    }),
    decline: defineRoute({
      path: "/peer-share/incoming/:id/decline",
      method: "post",
      request: noRequest<PathId>(),
      response: jsonResponse<{ ok: true }>(),
    }),
