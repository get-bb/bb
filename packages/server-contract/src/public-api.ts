...
import type {
  ...
  SystemRewindRolloutMetricsResponse,
  ...
  ThreadRewindPreviewQuery,
  ThreadRewindPreviewResponse,
  ThreadRewindRestoreRequest,
...
import {
  ...
  threadRewindCommitRequestSchema,
  threadRewindPreviewQuerySchema,
  threadRewindRestoreRequestSchema,
...
export const publicApiRoutes = {
  ...
  threads: {
    ...
    rewindPreview: defineRoute({
      path: "/threads/:id/rewind/preview",
      method: "get",
      request: queryRequest<PathId, ThreadRewindPreviewQuery>(
        threadRewindPreviewQuerySchema,
      ),
      response: jsonResponse<ThreadRewindPreviewResponse>(),
    }),
    rewindCommit: defineRoute({
      path: "/threads/:id/rewind",
      method: "post",
      request: jsonRequest<PathId, ThreadRewindCommitRequest>(
        threadRewindCommitRequestSchema,
      ),
      response: jsonResponse<ThreadRewindCommitResponse>(),
    }),
    rewindBranches: defineRoute({
      path: "/threads/:id/rewind/branches",
      method: "get",
      request: noRequest<PathId>(),
      response: jsonResponse<ThreadRewindBranchHistoryResponse>(),
    }),
    rewindRestore: defineRoute({
      path: "/threads/:id/rewind/restore",
      method: "post",
      request: jsonRequest<PathId, ThreadRewindRestoreRequest>(
        threadRewindRestoreRequestSchema,
      ),
      response: jsonResponse<ThreadRewindRestoreResponse>(),
    }),
  ...
  system: {
    ...
    rewindRolloutMetrics: defineRoute({
      path: "/system/rewind-rollout-metrics",
      method: "get",
      request: noRequest(),
      response: jsonResponse<SystemRewindRolloutMetricsResponse>(),
    }),
    config: defineRoute({
      path: "/system/config",
      method: "get",
