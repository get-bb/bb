...
declare const appSettingsSchema: z$1.ZodObject<{
    ...
    uiFontFamily: z$1.ZodString;
    bufferFontFamily: z$1.ZodString;
 ...
 */
declare const appSettingsUpdateSchema: z$1.ZodObject<{
    caffeinate: z$1.ZodOptional<z$1.ZodBoolean>;
    showKeyboardHints: z$1.ZodOptional<z$1.ZodBoolean>;
    steerActiveThreadOnEnter: z$1.ZodOptional<z$1.ZodBoolean>;
    showUnhandledProviderEvents: z$1.ZodOptional<z$1.ZodBoolean>;
    codexMemoryEnabled: z$1.ZodOptional<z$1.ZodBoolean>;
    claudeCodeMemoryEnabled: z$1.ZodOptional<z$1.ZodBoolean>;
    codexSubagentsDisabled: z$1.ZodOptional<z$1.ZodBoolean>;
    claudeCodeSubagentsDisabled: z$1.ZodOptional<z$1.ZodBoolean>;
    claudeCodeWorkflowsDisabled: z$1.ZodOptional<z$1.ZodBoolean>;
    uiFontFamily: z$1.ZodOptional<z$1.ZodString>;
    bufferFontFamily: z$1.ZodOptional<z$1.ZodString>;
    onboardingCompletedAt: z$1.ZodOptional<z$1.ZodNullable<z$1.ZodString>>;
}, z$1.core.$strict>;
...
declare const projectWorkspaceSettingsResponseSchema: z$1.ZodObject<{
    runScript: z$1.ZodNullable<z$1.ZodString>;
    setupScript: z$1.ZodNullable<z$1.ZodString>;
}, z$1.core.$strict>;
type ProjectWorkspaceSettingsResponse = z$1.infer<typeof projectWorkspaceSettingsResponseSchema>;
declare const updateProjectWorkspaceSettingsRequestSchema: z$1.ZodObject<{
    runScript: z$1.ZodOptional<z$1.ZodPipe<z$1.ZodNullable<z$1.ZodString>, z$1.ZodTransform<string | null, string | null>>>;
    setupScript: z$1.ZodOptional<z$1.ZodPipe<z$1.ZodNullable<z$1.ZodString>, z$1.ZodTransform<string | null, string | null>>>;
}, z$1.core.$strict>;
type UpdateProjectWorkspaceSettingsRequest = z$1.infer<typeof updateProjectWorkspaceSettingsRequestSchema>;
...
declare const hostDaemonCommandRegistry: {
    ...
    "environment.provision": HostDaemonCommandDescriptor<"environment.provision", z$1.ZodDiscriminatedUnion<[z$1.ZodObject<{
        ...
        setupScript: z$1.ZodOptional<z$1.ZodNullable<z$1.ZodString>>;
    ...
    "workspace.pull_request_action": HostDaemonCommandDescriptor<"workspace.pull_request_action", z$1.ZodDiscriminatedUnion<[z$1.ZodObject<{
        ...
        baseBranch: z$1.ZodOptional<z$1.ZodString>;
    ...
    "workspace.list_directory": HostDaemonCommandDescriptor<"workspace.list_directory", z$1.ZodObject<{
        environmentId: z$1.ZodString;
        workspaceContext: z$1.ZodObject<{
            workspacePath: z$1.ZodString;
            workspaceProvisionType: z$1.ZodEnum<{
        ...
        type: z$1.ZodLiteral<"workspace.list_directory">;
        path: z$1.ZodString;
    ...
    "workspace.pull_request": HostDaemonCommandDescriptor<"workspace.pull_request", z$1.ZodObject<{
        ...
        pullRequest: z$1.ZodObject<{
            ...
            comments: z$1.ZodArray<z$1.ZodObject<{
                authorLogin: z$1.ZodString;
                authorAvatarUrl: z$1.ZodNullable<z$1.ZodString>;
                bodySummary: z$1.ZodString;
...
declare const environmentDirectoryQuerySchema: z$1.ZodObject<{
    path: z$1.ZodOptional<z$1.ZodString>;
    cursor: z$1.ZodOptional<z$1.ZodString>;
    limit: z$1.ZodOptional<z$1.ZodString>;
}, z$1.core.$strip>;
type EnvironmentDirectoryQuery = z$1.infer<typeof environmentDirectoryQuerySchema>;
declare const environmentDirectoryResponseSchema: z$1.ZodDiscriminatedUnion<[z$1.ZodObject<{
    outcome: z$1.ZodLiteral<"available">;
    directory: z$1.ZodString;
    entries: z$1.ZodArray<z$1.ZodObject<{
        kind: z$1.ZodEnum<{
...
type EnvironmentDirectoryResponse = z$1.infer<typeof environmentDirectoryResponseSchema>;
...
declare const environmentPullRequestResponseSchema: z$1.ZodDiscriminatedUnion<[z$1.ZodObject<{
    ...
    pullRequest: z$1.ZodObject<{
        ...
        checkItems: z$1.ZodArray<z$1.ZodObject<{
            name: z$1.ZodString;
            status: z$1.ZodEnum<{
                unknown: "unknown";
                completed: "completed";
...
declare const terminalSessionSchema: z$1.ZodObject<{
    ...
    hostId: z$1.ZodString;
    title: z$1.ZodString;
    purpose: z$1.ZodOptional<z$1.ZodNullable<z$1.ZodEnum<{
        shell: "shell";
        setup: "setup";
        run: "run";
    }>>>;
...
declare const createTerminalRequestSchema: z$1.ZodObject<{
    ...
    purpose: z$1.ZodOptional<z$1.ZodEnum<{
        shell: "shell";
        setup: "setup";
        run: "run";
    }>>;
...
declare const terminalOutputResponseSchema: z$1.ZodObject<{
    chunks: z$1.ZodArray<z$1.ZodObject<{
        seq: z$1.ZodNumber;
        dataBase64: z$1.ZodString;
        dimensions: z$1.ZodOptional<z$1.ZodObject<{
            cols: z$1.ZodNumber;
            rows: z$1.ZodNumber;
        }, z$1.core.$strict>>;
    }, z$1.core.$strict>>;
...
declare const timelineGeneratedImageRowSchema: z$1.ZodObject<{
    id: z$1.ZodString;
    threadId: z$1.ZodString;
    turnId: z$1.ZodNullable<z$1.ZodString>;
    sourceSeqStart: z$1.ZodNumber;
    ...
    startedAt: z$1.ZodNumber;
    createdAt: z$1.ZodNumber;
    kind: z$1.ZodLiteral<"generated-image">;
    itemId: z$1.ZodString;
    path: z$1.ZodString;
}, z$1.core.$strip>;
type TimelineGeneratedImageRow = z$1.infer<typeof timelineGeneratedImageRowSchema>;
type TimelineSourceRow = TimelineConversationRow | TimelineWorkRow | TimelineSystemRow | TimelineGeneratedImageRow;
...
interface EnvironmentPullRequestCreateArgs {
    environmentId: string;
    draft: boolean;
}
...
interface EnvironmentDirectoryArgs extends EnvironmentDirectoryQuery {
    environmentId: string;
    signal?: AbortSignal;
}
...
type EnvironmentDirectoryResult = EnvironmentDirectoryResponse;
...
interface EnvironmentsArea {
    ...
    directory(args: EnvironmentDirectoryArgs): Promise<EnvironmentDirectoryResult>;
...
interface ProjectWorkspaceSettingsArgs {
    projectId: string;
    signal?: AbortSignal;
}
interface ProjectWorkspaceSettingsUpdateArgs extends UpdateProjectWorkspaceSettingsRequest {
    projectId: string;
}
...
type ProjectWorkspaceSettingsResult = ProjectWorkspaceSettingsResponse;
...
interface ProjectsArea {
    ...
    workspaceSettings(args: ProjectWorkspaceSettingsArgs): Promise<ProjectWorkspaceSettingsResult>;
    updateWorkspaceSettings(args: ProjectWorkspaceSettingsUpdateArgs): Promise<ProjectWorkspaceSettingsResult>;
}
