...
export {
  ...
  bunCommand as experimental_bunCommand,
  bunGlobalInstallCommand as experimental_bunGlobalInstallCommand,
  isBunManagedPi as experimental_isBunManagedPi,
  piInstallCommand as experimental_piInstallCommand,
