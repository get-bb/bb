...
describe("promoteRuntimeEntries", () => {
  ...
  // bb-fork(windows): Windows cannot rename over a file that a reader holds open.
  it.skipIf(process.platform === "win32")(
    "replaces staged exports without making a live export disappear",
    async () => {
      ...
      await writeFile(
        path.join(stagingDir, "provider-bridge.js"),
        "new bridge",
      );
