...
const INTENTIONAL_OPTIONAL_HOST_DAEMON_FIELDS: Record<string, string> = {
  ...
  "hostDaemonOnlineRpcCommandSchema.nativeSkillRoots":
    "host.list_commands includes nativeSkillRoots only for configured custom ACP providers.",
  "hostDaemonOnlineRpcCommandSchema.nativeSkillRoots.user":
    "custom ACP command discovery may omit user roots when only project roots are needed.",
  "hostDaemonOnlineRpcCommandSchema.nativeSkillRoots.project":
    "custom ACP command discovery may omit project roots when only user roots are needed.",
