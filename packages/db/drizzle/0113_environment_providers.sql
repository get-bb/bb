...
--> statement-breakpoint
ALTER TABLE `environments` ADD `environment_provider_id` text;
--> statement-breakpoint
ALTER TABLE `environments` ADD `provider_owns_path` integer DEFAULT false NOT NULL;
--> statement-breakpoint
ALTER TABLE `environments` ADD `environment_provider_selection` text;
--> statement-breakpoint
ALTER TABLE `environments` ADD `environment_provider_instance_key` text;
--> statement-breakpoint
ALTER TABLE `environments` ADD `retire_at` integer;
--> statement-breakpoint
ALTER TABLE `environments` ADD `teardown_attempt` integer DEFAULT 0 NOT NULL;
--> statement-breakpoint
ALTER TABLE `environments` ADD `teardown_status` text;
--> statement-breakpoint
ALTER TABLE `environments` ADD `teardown_message` text;
--> statement-breakpoint
ALTER TABLE `environments` ADD `resource` text;
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE `environments` DROP COLUMN `managed`;
--> statement-breakpoint
ALTER TABLE `environments` DROP COLUMN `destroy_attempt_id`;
--> statement-breakpoint
