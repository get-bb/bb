 ...
 * exercise the compare-and-set branch, which better-sqlite3's synchronous
 * transactions make unreachable through the public API alone.
 */
function withWriteAfterFirstRead<T extends object>(
  connection: T,
  onFirstRead: () => void,
): T {
