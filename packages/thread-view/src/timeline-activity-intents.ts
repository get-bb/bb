 ...
 * and tool calls through their parsed `activityIntents`, and the grammar v3
 * `file-read` / `search` rows through the intent their structured fields
 * derive to (see {@link timelineRowActivityIntents}).
 */
