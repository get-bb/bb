    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Report its CLI's install source and shadowing installs, and build install and update commands that follow the host's package manager preference (auto, mise, or npm) from the provider-bridge kit",
        ],
        apiSymbols: [
          ...
          "experimental_resolveMiseBinary",
          "experimental_probeMisePackage",
          "experimental_misePackageSpec",
          "experimental_miseUseCommand",
          "experimental_resolvePackageInstaller",
          "experimental_packageManagerPreferenceSchema",
          "experimental_providerInstallationShadowingInstallSchema",
          "ExperimentalPackageManagerPreference",
          "ExperimentalProviderInstallationShadowingInstall",
          "ExperimentalMiseKitIo",
          "ExperimentalMisePackageProbe",
          "ExperimentalPackageInstallerResolution",
        ],
        firstParty: [
          "ACP providers",
