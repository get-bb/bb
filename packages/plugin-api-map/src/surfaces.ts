    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Use experimental_SessionComposer for an existing external session: supply value/onChange, commands, and onSubmit({text, files}); bb renders the same editor, Skills menu, attachments, and voice controls. No thread is created. Rejected sends retain the draft. Attachments are opt-in and bounded; the plugin owns their transfer",
          ...
          "Set navPanel experimental_rightPanel: false for pages that do not need bb browser/terminal tools; this omits the right panel and toggle and cannot be combined with fixedTabs",
        ...
        apiSymbols: [
          ...
          "ExperimentalSessionComposerCommand",
        ],
