    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Coordinate with its tab controller through plugin-local state",
          "Keep Browser work in a whole-tab controller instead of the navigation chrome",
        ],
        apiSymbols: ["PluginBrowserActionRegistration", "PluginBrowserActionProps"],
        experimental: true,
      },
      {
        id: "browser-controllers",
        title: "Whole Browser tab controllers",
        summary:
          "Mounts one full-surface plugin controller per logical Browser tab. With this, a plugin can:",
        bullets: [
          "Own the complete selection workflow, review tray, and drawing editor for an exact tab revision",
          "Follow the exact tab through navigation and disposal with experimental_lifecycleSignal and experimental_onLifecycle, and keep drafts keyed by client, window, thread, project, and navigation epoch",
          "Register a request handler that bb.experimental_browser.experimental_requestContribution and `bb browser plugin` address for this exact revision",
          "Run bounded page scripts and capture a Blob-URL preview through experimental_capturePage when experimental_browserControlAvailable is true",
          "Register a generated Blob through experimental_createImageResource({ blob, pixelSize? }, { signal? }) and receive a bounded capture descriptor",
          "Read captured bytes after navigation — descriptors are immutable — while creation rejects a target whose navigation epoch is stale",
        ],
        apiSymbols: [
          "ExperimentalBrowserControllerLifecycle",
          "ExperimentalBrowserControllerProps",
          "ExperimentalBrowserControllerRegistration",
          "ExperimentalBrowserControllerProps.experimental_browserControlAvailable",
          "ExperimentalBrowserControllerProps.experimental_lifecycleSignal",
          "ExperimentalBrowserControllerProps.experimental_onLifecycle",
          "ExperimentalBrowserControllerProps.experimental_registerRequestHandler",
          "ExperimentalBrowserControllerProps.experimental_capturePage",
          "ExperimentalBrowserPageCapture.dispose",
          "ExperimentalBrowserImageResourceInput",
          "ExperimentalBrowserControllerProps.experimental_createImageResource",
          "PluginBrowser.experimental_requestContribution",
          "ExperimentalBrowserCaptureDescriptor",
