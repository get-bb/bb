    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Call hosts.experimental_reconcile from plugin-owned maintenance to enforce core’s suspended state through the provider; active and transitional states are unchanged, the call waits for completion, and core does not poll. Request new pauses with experimental_suspend",
