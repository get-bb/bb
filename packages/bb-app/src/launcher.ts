...
const STARTUP_ONLY_MANAGED_ENV_KEYS = new Set<string>([
  ...
  "BB_SERVER_BIND_HOST",
  "BB_SERVER_PORT",
  "BB_SQLITE_CACHE_SIZE_KIB",
  "BB_SQLITE_MMAP_SIZE_BYTES",
  "BB_TELEMETRY",
  "BB_TRANSCRIPTION",
]);
...
Startup-only server and launcher keys:
  ...
  BB_SERVER_BIND_HOST, BB_SERVER_PORT, BB_SQLITE_CACHE_SIZE_KIB,
  BB_SQLITE_MMAP_SIZE_BYTES, BB_TELEMETRY, BB_TRANSCRIPTION,
