...
describe("acp process topology", () => {
  ...
  // bb-fork(windows): releasing a timed-out construction needs POSIX process groups.
  it.skipIf(process.platform === "win32")(
    "releases the thread on the bridge when a construction times out on the runtime's side",
    async () => {
