...
- Never include the exact `@codex security review` command in an agent-created PR body or comment. Use non-command wording, such as "security-focused review," when that discussion is needed.
