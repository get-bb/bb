...
/**
 * Shared hard ceiling for diff file enumeration and untracked content reads.
 * At 500 files the daemon's conservative 16 KiB-per-file numstat budget stays
 * near 8 MiB; larger diffs are declined before stats/content work. Keeping one
 * policy also bounds alternate-index work and the returned table of contents.
 */
