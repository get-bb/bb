...
- Read references/backend-events.md for lifecycle events, environment providers, machine providers,
  enrollment/bootstrap helpers, server access, HTTP, RPC, realtime, background services, and schedules.
