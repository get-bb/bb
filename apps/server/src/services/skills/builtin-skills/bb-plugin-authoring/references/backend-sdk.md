...
| `threadSections` | `list` `get` `create` `update` `delete`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
Get one section with `await bb.sdk.threadSections.get({ sectionId })`. The
input also accepts `signal`, and the promise returns `ThreadSectionResponse`.
A missing section rejects with an API error.
