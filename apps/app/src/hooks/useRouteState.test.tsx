...
import { useRouteState, type RouteState } from "./useRouteState";

interface RouteCaptureProps {
  onRoute: (route: RouteState) => void;
}
...
function renderRouteCapture(args: RenderRouteCaptureArgs): RouteState {
  let capturedRoute: RouteState | null = null;
  render(
