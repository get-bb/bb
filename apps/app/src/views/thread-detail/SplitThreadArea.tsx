...
function SplitThreadAreaContent({ routeContent }: SplitThreadAreaProps) {
  ...
  const [maximizedPaneId, setMaximizedPaneId] = useAtom(maximizedPaneIdAtom);
  ...
  const pruneStalePane = useCallback(
    ...
    [maximizedPaneId, navigate, store],
  );
  ...
  return (
    <>
      ...
      {/* Full-bleed like the single-pane page surface: outer edges stay flush,
          ...
          min content height. */}
      <div className="relative -m-4 flex min-h-0 min-w-0 flex-1 overflow-hidden md:-m-5">
