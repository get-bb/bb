  ...
  return createPortal(
    <>
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 right-0 flex h-(--bb-shell-height) touch-pan-y select-none flex-col overflow-hidden border-l border-border-seam bg-background pt-[var(--bb-native-safe-area-top,env(safe-area-inset-top))] pr-[var(--bb-native-safe-area-right,env(safe-area-inset-right))] pb-[var(--bb-safe-area-bottom,var(--bb-native-safe-area-bottom,env(safe-area-inset-bottom)))] pl-[var(--bb-native-safe-area-left,env(safe-area-inset-left))] outline-none",
