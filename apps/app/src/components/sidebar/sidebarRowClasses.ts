...
export const SIDEBAR_SECTION_DROP_TARGET_CLASS =
  "pointer-events-none absolute -inset-x-1 -inset-y-0.5 z-[70] rounded-md bg-sidebar-accent/45 ring-1 ring-inset ring-sidebar-ring/80";
