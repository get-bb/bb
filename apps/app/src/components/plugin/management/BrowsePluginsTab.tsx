  ...
  const headerAction =
    installedPluginId !== null ? (
      <ResourceInstallControl
        ...
        className="border-success/40 bg-success/15 text-[color:color-mix(in_oklab,var(--success)_72%,var(--ink))] hover:border-success/55 hover:bg-success/25 focus-visible:border-success/55 focus-visible:bg-success/25"
