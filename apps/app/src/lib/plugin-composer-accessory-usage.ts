...
export const PLUGIN_COMPOSER_ACCESSORY_USAGE_STORAGE_KEY =
  "bb.pluginComposerAccessoryUsage.v1";
...
function handleStorage(event: StorageEvent): void {
  if (event.key !== PLUGIN_COMPOSER_ACCESSORY_USAGE_STORAGE_KEY) return;
...
export function recordPluginComposerAccessoryUse(pluginId: string): void {
...
export function usePluginComposerAccessoryUsage(): Readonly<
...
export function resetPluginComposerAccessoryUsageForTest(): void {
  initialized = false;
